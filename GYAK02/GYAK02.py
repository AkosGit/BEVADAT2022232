...
Original file is located at
    https://colab.research.google.com/drive/1AMHoozZcJv9kcIf3U-PFqKrTyin-XgOF
"""
...
def round_array(arr, to=2):
  return np.round(arr,to)
#round_array(np.array([0.1223, 0.1675]))
...
def bool_array(arr):
  return np.ma.masked_values(arr,1).mask
...
def invert_bool_array(arr):
  return np.ma.masked_values(arr,0).mask
